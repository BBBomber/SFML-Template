...
void MainMenu::initializeButtons(const sf::Font& font) {
    buttons.push_back(Button(font, "PvP", 300.0f, 200.0f, 200.0f, 50.0f, sf::Color::Blue, sf::Color::White, sf::Color::Yellow, 2.0f, [&]() {
        gameState = GameState::PlayingPvP;  // Change game state to PvP
        }));
    buttons.push_back(Button(font, "Vs AI", 300.0f, 300.0f, 200.0f, 50.0f, sf::Color::Green, sf::Color::White, sf::Color::Yellow, 2.0f, []() {
        std::cout << "Vs AI Button Clicked!" << std::endl;
        }));
    buttons.push_back(Button(font, "Quit", 300.0f, 400.0f, 200.0f, 50.0f, sf::Color::Red, sf::Color::White, sf::Color::Yellow, 2.0f, []() {
